...
--
-- Host: localhost    Database: opencart_db
-- ------------------------------------------------------
...
INSERT INTO `oc_api` VALUES (1,'Default','',1,'2019-07-17 13:02:17','2019-07-17 13:02:17');
...
INSERT INTO `oc_attribute` VALUES (1,1,1),(2,1,2),(3,1,3);
...
INSERT INTO `oc_attribute_description` VALUES (1,1,'No. of Cores'),(2,1,'Clockspeed'),(3,1,'Memory'),(1,2,'Nº de núcleos'),(2,2,'Velocidade de clock'),(3,2,'Memória');
...
INSERT INTO `oc_attribute_group_description` VALUES (1,1,'Technical'),(1,2,'Informações técnicas');
...
INSERT INTO `oc_banner` VALUES (1,'Produtos HP',1),(2,'Slideshow na Home',1),(3,'Fabricantes',1);
...
INSERT INTO `oc_cron` VALUES (3,'session','day','cron/session',1,'2019-03-19 04:33:00','2019-03-19 04:33:00');
...
INSERT INTO `oc_currency` VALUES (1,'US Dollar','USD','$','','2',4.28000000,1,'2018-09-08 08:00:00'),(2,'Real','BRL','R$','','2',1.00000000,1,'2018-09-08 18:00:00');
...
INSERT INTO `oc_customer_group_description` VALUES (1,1,'Default',''),(1,2,'Padrão','');
...
INSERT INTO `oc_geo_zone` VALUES (1,'Brasil','Todo o Brasil','2009-01-06 23:26:25','2010-02-26 22:33:24');
...
INSERT INTO `oc_language` VALUES (1,'English','en-gb','en-US,en_US.UTF-8,en_US,en-gb,english','en-gb.png','en-gb',1,1),(2,'Português','pt-br','pt-BR,pt_BR.UTF-8,pt_BR,pt-br,portuguese','pt-br.png','pt-br',1,1);
...
INSERT INTO `oc_layout` VALUES (1,'Página principal'),(2,'Página de detalhes do produto'),(3,'Página de departamentos'),(4,'Padrão'),(5,'Página de marcas'),(6,'Minha conta'),(7,'Finalização'),(8,'Formulário de contato'),(9,'Mapa do site'),(10,'Afiliados'),(11,'Páginas de informações'),(12,'Página de compraração'),(13,'Resultado da busca');
...
INSERT INTO `oc_layout_module` VALUES (1,5,'0','column_left',2),(2,10,'account','column_right',1),(3,6,'account','column_right',1),(4,1,'carousel.29','content_top',3),(5,1,'slideshow.27','content_top',1),(6,1,'featured.28','content_top',2),(7,3,'category','column_left',1),(8,3,'banner.30','column_left',2);
...
INSERT INTO `oc_length_class_description` VALUES (1,1,'Centimeter','cm'),(2,1,'Millimeter','mm'),(3,1,'Inch','in'),(1,2,'Centímetro','cm'),(2,2,'Mílimetro','mm'),(3,2,'Polegada','in');
...
INSERT INTO `oc_manufacturer` VALUES (5,'HTC','catalog/demo/htc_logo.jpg',0),(6,'Palm','catalog/demo/palm_logo.jpg',0),(7,'HP','catalog/demo/hp_logo.jpg',0),(8,'Apple','catalog/demo/apple_logo.jpg',0),(9,'Canon','catalog/demo/canon_logo.jpg',0),(10,'Sony','catalog/demo/sony_logo.jpg',0);
...
INSERT INTO `oc_product_attribute` VALUES (43,1,1,'2'),(43,2,1,'2.16GHz'),(43,3,1,'1GB'),(43,1,2,'2'),(43,2,2,'2.16GHz'),(43,3,2,'1GB');
...
INSERT INTO `oc_product_option` VALUES (224,35,11,'',1),(225,47,12,'2011-04-22',1),(223,42,2,'',1),(217,42,5,'',1),(209,42,6,'',1),(218,42,1,'',1),(208,42,4,'teste',1),(219,42,8,'2011-02-20',1),(222,42,7,'',1),(221,42,9,'22:25',1),(220,42,10,'2011-02-20 22:25',1),(226,30,5,'',1);
...
INSERT INTO `oc_product_reward` VALUES (1,42,1,100),(2,47,1,300),(3,28,1,400),(4,43,1,600),(5,29,1,0),(6,48,1,0),(7,40,1,0),(8,30,1,200),(9,44,1,700),(10,45,1,800),(11,31,1,0),(12,35,1,0),(13,33,1,0),(14,46,1,0),(15,41,1,0),(16,36,1,0),(17,34,1,0),(18,32,1,0),(19,49,1,1000);
...
INSERT INTO `oc_product_special` VALUES (1,42,1,1,90.0000,'0000-00-00','0000-00-00'),(2,30,1,2,90.0000,'0000-00-00','0000-00-00'),(3,30,1,1,80.0000,'0000-00-00','0000-00-00');
...
INSERT INTO `oc_return_action` VALUES (1,1,'Refunded'),(2,1,'Credit Issued'),(3,1,'Replacement Sent'),(1,2,'Reembolsado'),(2,2,'Crédito liberado'),(3,2,'Substituição enviada');
...
INSERT INTO `oc_return_reason` VALUES (1,1,'Dead On Arrival'),(2,1,'Received Wrong Item'),(3,1,'Order Error'),(4,1,'Faulty, please supply details'),(5,1,'Other, please supply details'),(1,2,'Chegou quebrado'),(2,2,'Produto trocado'),(3,2,'Erro no pedido'),(4,2,'Defeito, forneça detalhes'),(5,2,'Outros, forneça detalhes');
...
INSERT INTO `oc_return_status` VALUES (1,1,'Pending'),(2,1,'Awaiting Products'),(3,1,'Complete'),(1,2,'Pendente'),(2,2,'Aguardando produtos'),(3,2,'Concluída');
...
INSERT INTO `oc_session` VALUES ('158b0b5c5cb50e356a6fc6e54c','{\"user_id\":\"1\",\"user_token\":\"34451511aa8867e2ea13fdde83bf1e52\"}','2019-07-17 14:07:13');
...
INSERT INTO `oc_stock_status` VALUES (5,1,'Out Of Stock'),(6,1,'2-3 Days'),(7,1,'In Stock'),(8,1,'Pre-Order'),(5,2,'Esgotado'),(6,2,'2 a 3 dias'),(7,2,'Em estoque'),(8,2,'Sob orçamento');
...
INSERT INTO `oc_user` VALUES (1,1,'admin','798c7408fa7fe94e1758ad320dee86d485fd5993','6f36326da','Fulano','de Tal','comunidade@vindi.com.br','','','172.18.0.1',1,'2019-07-17 13:02:17');
...
INSERT INTO `oc_voucher_theme` VALUES (1,'catalog/demo/canon_eos_5d_2.jpg'),(2,'catalog/demo/gift-voucher-birthday.jpg'),(3,'catalog/demo/apple_logo.jpg');
...
INSERT INTO `oc_voucher_theme_description` VALUES (1,1,'General'),(2,1,'Birthday'),(3,1,'Christmas'),(1,2,'Geral'),(2,2,'Aniversário'),(3,2,'Natal');
...
INSERT INTO `oc_weight_class_description` VALUES (1,1,'Kilogram','kg'),(2,1,'Gram','g'),(5,1,'Pound ','lb'),(6,1,'Ounce','oz'),(1,2,'Quilograma','kg'),(2,2,'Grama','g'),(5,2,'Libra ','lb'),(6,2,'Onça','oz');
...
INSERT INTO `oc_zone_to_geo_zone` VALUES (1,30,0,1,'0000-00-00 00:00:00','0000-00-00 00:00:00');
...
-- Dump completed on 2019-07-17 13:23:38
